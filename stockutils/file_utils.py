...
brk_dict={"IDBI":"./cntrfiles/idbi.txt","Axis":"./cntrfiles/axis.txt","geojit":"./cntrfiles/geojit.txt","vent":'./cntrfiles/ventura.txt',"bob":'./cntrfiles/bob.txt',"hdfc":'./cntrfiles/hdfc.txt',"dolat":"./cntrfiles/dolat.txt","keynote":"./cntrfiles/keynote.txt"}
